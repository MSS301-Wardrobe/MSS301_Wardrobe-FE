...
import { ArrowLeft, Star, Heart, Share2, ChevronRight, Loader2 } from "lucide-react";
...
export function RecommendationDetails() {
  ...
  // ĐÃ CẬP NHẬT: Lấy ảnh bìa chi tiết theo cơ chế mã hóa ID tập trung
  const dynamicCoverImg = getDynamicOutfitImage(recommendation.recommendationId, outfit.outfitName, recommendation.eventType);
