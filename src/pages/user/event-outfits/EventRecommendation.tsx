...
const recommendations: Record<string, Outfit[]> = {
  work: [
    { id: "w1", title: "Chuyên Nghiệp Uy Quyền", score: 96, source: "AI + Sở Thích", sourceColor: "#EA580C", reason: "Phù hợp phong cách tối giản và lịch sử công sở của bạn", img: "https://images.unsplash.com/photo-1700557477506-369b241cbe54?w=400&h=500&fit=crop", items: 4, tags: ["Trang Trọng", "Tối Giản"], favorites: 24 },
    { id: "w2", title: "Quyền Lực Lịch Sự", score: 91, source: "Nhóm Bạn", sourceColor: "#F97316", reason: "Phổ biến trong nhóm Minimalist Collective tuần này", img: "https://images.unsplash.com/photo-1731589802956-b4693dae884b?w=400&h=500&fit=crop", items: 4, tags: ["Kinh Doanh", "Sắc Sảo"], favorites: 18 },
  ...
  casual: [
    { id: "c1", title: "Cuối Tuần Tối Giản", score: 93, source: "AI + Sở Thích", sourceColor: "#EA580C", reason: "Màu sắc yêu thích và sở thích phong cách thường ngày của bạn", img: "https://images.unsplash.com/photo-1619086303291-0ef7699e4b31?w=400&h=500&fit=crop", items: 3, tags: ["Thoải Mái", "Gọn Gàng"], favorites: 42 },
    ...
    { id: "c3", title: "Đường Phố Tự Nhiên", score: 85, source: "Nhóm Bạn", sourceColor: "#F97316", reason: "Đang thịnh hành trong nhóm Street Style Crew", img: "https://images.unsplash.com/photo-1617690033147-ce6b332d677b?w=400&h=500&fit=crop", items: 3, tags: ["Đường Phố", "Nổi Bật"], favorites: 19 },
  ],
  party: [
    { id: "p1", title: "Rực Rỡ Buổi Tối", score: 95, source: "AI + Sở Thích", sourceColor: "#EA580C", reason: "Cân bằng hoàn hảo giữa thanh lịch và lễ hội cho sự kiện xã hội", img: "https://images.unsplash.com/photo-1617690033147-ce6b332d677b?w=400&h=500&fit=crop", items: 5, tags: ["Thanh Lịch", "Lễ Hội"], favorites: 56 },
  ...
  wedding: [
    { id: "wed1", title: "Thanh Lịch Vườn Hoa", score: 94, source: "AI + Sở Thích", sourceColor: "#EA580C", reason: "Cổ điển và phù hợp cho lễ cưới ngoài trời", img: "https://images.unsplash.com/photo-1700557477506-369b241cbe54?w=400&h=500&fit=crop", items: 5, tags: ["Trang Trọng", "Lãng Mạn"], favorites: 63 },
  ...
  travel: [
    { id: "t1", title: "Lữ Hành Đa Năng", score: 92, source: "AI + Sở Thích", sourceColor: "#EA580C", reason: "Các món đồ phối hợp linh hoạt, gọn nhẹ mà vẫn đẹp", img: "https://images.unsplash.com/photo-1634921276069-c24ba5d6b35c?w=400&h=500&fit=crop", items: 6, tags: ["Thực Dụng", "Đa Năng"], favorites: 35 },
  ...
  interview: [
    { id: "i1", title: "Ấn Tượng Đầu Tiên", score: 98, source: "AI + Sở Thích", sourceColor: "#EA580C", reason: "Bộ trang phục điểm cao nhất cho ấn tượng chuyên nghiệp đầu tiên trong ngành của bạn", img: "https://images.unsplash.com/photo-1731589802956-b4693dae884b?w=400&h=500&fit=crop", items: 4, tags: ["Chuyên Nghiệp", "Tự Tin"], favorites: 78 },
      ...
      <div style={{ background: "linear-gradient(135deg, #0F172A 0%, #1E293B 50%, #C2410C 100%)", borderRadius: 20, padding: "28px 32px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <button
            ...
            style={{ padding: "10px 18px", borderRadius: 10, background: "#EA580C", color: "white", border: "none", cursor: "pointer", fontWeight: 600, fontSize: "0.875rem", display: "flex", alignItems: "center", gap: 6 }}
          >
            <Sparkles size={14} />
            Nhận Gợi Ý
          </button>
