...
export function AIRequestsLog() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      <div>
        <h2 style={{ fontSize: "1.3rem", fontWeight: 800, color: "#0F172A", marginBottom: 4 }}>Lịch Sử Nhận Diện AI</h2>
        <p style={{ color: "#64748B", fontSize: "0.85rem" }}>Theo dõi các yêu cầu nhận diện AI và kết quả xử lý</p>
      </div>
      ...
      <div style={{ background: "white", borderRadius: 16, padding: 48, border: "1px solid #E2E8F0", boxShadow: "0 2px 12px rgba(0,0,0,0.04)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: 12 }}>
        ...
        <h3 style={{ fontWeight: 700, color: "#0F172A", fontSize: "1rem" }}>Nhật ký yêu cầu AI</h3>
        <p style={{ color: "#64748B", fontSize: "0.85rem", maxWidth: 420 }}>
          Khu vực này sẽ hiển thị lịch sử các yêu cầu nhận diện AI, thời gian xử lý và độ chính xác. Tính năng sẽ được kết nối với API trong giai đoạn tiếp theo.
        </p>
      </div>
    </div>
  );
